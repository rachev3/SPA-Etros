...
const HomePage = () => {
  const { articles, loading, error } = useArticles(1, 3); // Get first page with 3 articles

  // Helper function to render news cards
        ...
        <Link to={`/news/article/${article._id}`} className="block">
          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-yellow-500 font-semibold hover:text-yellow-400 transition-colors duration-200 inline-flex items-center">
                Read More
                <svg
